...
|---| ----- | -------- | ---------- |
|1002|[Find Common Characters](https://leetcode.com/problems/find-common-characters/) | [Python](./algorithms/python/FindCommonCharacters/commonChars.py)|Easy|
|999|[Available Captures for Rook](https://leetcode.com/problems/available-captures-for-rook/) | [Python](./algorithms/python/AvailableCapturesforRook/numRookCaptures.py)|Easy|
...
|985|[Sum of Even Numbers After Queries](https://leetcode.com/problems/sum-of-even-numbers-after-queries/) | [Python](./algorithms/python/SumOfEvenNumbersAfterQueries/sumEvenAfterQueries.py)|Easy|
...
|974|[Subarray Sums Divisible by K](https://leetcode.com/problems/subarray-sums-divisible-by-k/) | [Python](./algorithms/python/SubarraySumsDivisibleByK/subarraysDivByK.py)|Medium|
|973|[K Closest Points to Origin](https://leetcode.com/problems/k-closest-points-to-origin/) | [Python](./algorithms/python/KClosestPointsToOrigin/kClosest.py)|Easy|
...
|965|[Univalued Binary Tree](https://leetcode.com/problems/univalued-binary-tree/) | [Python](./algorithms/python/UnivaluedBinaryTree/isUnivalTree.py)|Medium|
|961|[N-Repeated Element in Size 2N Array](https://leetcode.com/problems/n-repeated-element-in-size-2n-array/) | [Python](./algorithms/python/N-RepeatedElementInSize2NArray/repeatedNTimes.py)|Easy|
...
|945|[Minimum Increment to Make Array Unique](https://leetcode.com/problems/minimum-increment-to-make-array-unique/) | [Python](./algorithms/python/MinimumIncrementToMakeArrayUnique/minIncrementForUnique.py)|Medium|
...
|926|[Flip String to Monotone Increasing](https://leetcode.com/problems/flip-string-to-monotone-increasing/) | [Python](./algorithms/python/FlipStringToMonotoneIncreasing/minFlipsMonoIncr.py)|Medium|
|919|[Complete Binary Tree Inserter](https://leetcode.com/problems/complete-binary-tree-inserter/) | [Python](./algorithms/python/CompleteBinaryTreeInserter/CBTInserter.py)|Medium|
|915|[Partition Array into Disjoint Intervals](https://leetcode.com/problems/partition-array-into-disjoint-intervals/) | [Python](./algorithms/python/PartitionArrayIntoDisjointIntervals/partitionDisjoint.py)|Medium|
...
|900|[RLE Iterator](https://leetcode.com/problems/rle-iterator/) | [Python](./algorithms/python/RLEIterator/RLEIterator.py)|Medium|
|897|[Increasing Order Search Tree](https://leetcode.com/problems/increasing-order-search-tree/) | [Python](./algorithms/python/IncreasingOrderSearchTree/increasingBST.py)|Easy|
|894|[All Possible Full Binary Trees](https://leetcode.com/problems/all-possible-full-binary-trees/) | [Python](./algorithms/python/AllPossibleFullBinaryTrees/allPossibleFBT.py)|Medium|
|873|[Length of Longest Fibonacci Subsequence](https://leetcode.com/problems/length-of-longest-fibonacci-subsequence//) | [Python](./algorithms/python/LengthOfLongestFibonacciSubsequence/lenLongestFibSubseq.py)|Medium|
|872|[Leaf-Similar Trees](https://leetcode.com/problems/leaf-similar-trees/) | [Python](./algorithms/python/Leaf-SimilarTrees/leafSimilar.py)|Easy|
|870|[Advantage Shuffle](https://leetcode.com/problems/advantage-shuffle/) | [Python](./algorithms/python/AdvantageShuffle/advantageCount.py)|Medium|
|865|[Smallest Subtree with all the Deepest Nodes](https://leetcode.com/problems/smallest-subtree-with-all-the-deepest-nodes/) | [Python](./algorithms/python/SmallestSubtreeWithAllTheDeepestNodes/subtreeWithAllDeepest.py)|Medium|
|863|[All Nodes Distance K in Binary Tree](https://leetcode.com/problems/all-nodes-distance-k-in-binary-tree/) | [Python](./algorithms/python/AllNodesDistanceKInBinaryTree/distanceK.py)|Medium|
...
|814|[Binary Tree Pruning](https://leetcode.com/problems/binary-tree-pruning/) | [Python](./algorithms/python/BinaryTreePruning/pruneTree.py)|Medium|
...
|795|[Number of Subarrays with Bounded Maximum](https://leetcode.com/problems/number-of-subarrays-with-bounded-maximum/) | [Python](./algorithms/python/NumberOfSubarraysWithBoundedMaximum/numSubarrayBoundedMax.py)|Medium|
...
|718|[Maximum Length of Repeated Subarray](https://leetcode.com/problems/maximum-length-of-repeated-subarray/) | [Python](./algorithms/python/MaximumLengthOfRepeatedSubarray/findLength.py)|Medium|
...
|700|[Search in a Binary Search Tree](https://leetcode.com/problems/search-in-a-binary-search-tree/) | [Python](./algorithms/python/SearchInABinarySearchTree/searchBST.py)|Easy|
...
|670|[Maximum Swap](https://leetcode.com/problems/maximum-swap/) | [Python](./algorithms/python/MaximumSwap/maximumSwap.py)|Medium|
|669|[Trim a Binary Search Tree](https://leetcode.com/problems/trim-a-binary-search-tree/) | [Python](./algorithms/python/TrimBinarySearchTree/trimBST.py)|Easy|
...
|654|[Maximum Binary Tree](https://leetcode.com/problems/maximum-binary-tree/) | [Python](./algorithms/python/MaximumBinaryTree/constructMaximumBinaryTree.py)|Medium|
|653|[Two Sum IV - Input is a BST](https://leetcode.com/problems/two-sum-iv-input-is-a-bst/) | [Python](./algorithms/python/TwoSumIV-InputIsABST/findTarget.py)|Easy|
...
|637|[Average of Levels in Binary Tree](https://leetcode.com/problems/average-of-levels-in-binary-tree/) | [Python](./algorithms/python/AverageOfLevelsInBinaryTree/averageOfLevels.py)|Easy|
...
|621|[Task Scheduler](https://leetcode.com/problems/task-scheduler/) | [Python](./algorithms/python/TaskScheduler/leastInterval.py)|Medium|
|617|[Merge Two Binary Trees](https://leetcode.com/problems/merge-two-binary-trees/) | [Python](./algorithms/python/MergeTwoBinaryTrees/mergeTrees.py)|Easy|
|606|[Construct String from Binary Tree](https://leetcode.com/problems/construct-string-from-binary-tree/) | [Python](./algorithms/python/ConstructStringFromBinaryTree/tree2str.py)|Easy|
|590|[N-ary Tree Postorder Traversal](https://leetcode.com/problems/n-ary-tree-postorder-traversal/) | [Python](./algorithms/python/N-aryTreePostorderTraversal/postorder.py)|Easy|
|589|[N-ary Tree Preorder Traversal](https://leetcode.com/problems/n-ary-tree-preorder-traversal/) | [Python](./algorithms/python/N-aryTreePreorderTraversal/preorder.py)|Easy|
...
|560|[Subarray Sum Equals K](https://leetcode.com/problems/subarray-sum-equals-k/) | [Python](./algorithms/python/SubarraySumEqualsK/subarraySum.py)|Medium|
|559|[Maximum Depth of N-ary Tree](https://leetcode.com/problems/maximum-depth-of-n-ary-tree/) | [Python](./algorithms/python/MaximumDepthOfN-aryTree/maxDepth.py)|Easy|
...
|515|[Find Largest Value in Each Tree Row](https://leetcode.com/problems/find-largest-value-in-each-tree-row/) | [Python](./algorithms/python/FindLargestValueInEachTreeRow/largestValues.py)|Medium|
|513|[Find Bottom Left Tree Value](https://leetcode.com/problems/find-bottom-left-tree-value/) | [Python](./algorithms/python/FindBottomLeftTreeValue/findBottomLeftValue.py)|Medium|
|509|[Fibonacci Number](https://leetcode.com/problems/fibonacci-number/) | [Python](./algorithms/python/FibonacciNumber/fib.py)|Easy|
|508|[Most Frequent Subtree Sum](https://leetcode.com/problems/most-frequent-subtree-sum/) | [Python](./algorithms/python/MostFrequentSubtreeSum/findFrequentTreeSum.py)|Medium|
|501|[Find Mode in Binary Search Tree](https://leetcode.com/problems/find-mode-in-binary-search-tree/) | [Python](./algorithms/python/FindModeInBinarySearchTree/findMode.py)|Easy|
|494|[Target Sum](https://leetcode.com/problems/target-sum/) | [Python](./algorithms/python/TargetSum/findTargetSumWays.py)|Medium|
...
|429|[N-ary Tree Level Order Traversal](https://leetcode.com/problems/n-ary-tree-level-order-traversal/) | [Python](./algorithms/python/N-aryTreeLevelOrderTraversal/levelOrder.py)|Easy|
...
|380|[Insert Delete GetRandom O(1)](https://leetcode.com/problems/insert-delete-getrandom-o1/) | [C++](./algorithms/cpp/insertDeleteGetRandom/InsertDeleteGetrandomO1.cpp), [Python](./algorithms/python/InsertDeleteGetRandomO(1)/RandomizedSet.py)|Hard|
...
|361|[Bomb Enemy](https://leetcode.com/problems/bomb-enemy/) | [Python](./algorithms/python/BombEnemy/maxKilledEnemies.py)|Medium|
...
|318|[Maximum Product of Word Lengths](https://leetcode.com/problems/maximum-product-of-word-lengths/) | [C++](./algorithms/cpp/maximumProductOfWordLengths/MaximumProductOfWordLengths.cpp), [Python](./algorithms/python/MaximumProductOfWordLengths/maxProduct.py)|Medium|
...
|309|[Best Time to Buy and Sell Stock with Cooldown](https://leetcode.com/problems/best-time-to-buy-and-sell-stock-with-cooldown/) | [Python](./algorithms/python/BestTimeToBuyAndSellStockWithCooldown/maxProfit.py)|Medium|
...
|226|[Invert Binary Tree](https://leetcode.com/problems/invert-binary-tree/)| [C++](./algorithms/cpp/invertBinaryTree/InvertBinaryTree.cpp), [Python](./algorithms/python/InvertBinaryTree/invertTree.py)|Easy|
...
|215|[Kth Largest Element in an Array](https://leetcode.com/problems/kth-largest-element-in-an-array/)| [C++](./algorithms/cpp/kthLargestElementInAnArray/KthLargestElementInAnArray.cpp), [Python](./algorithms/python/kthLargestElementInAnArray/findKthLargest.py)|Medium|
...
|199|[Binary Tree Right Side View](https://leetcode.com/problems/binary-tree-right-side-view/)| [C++](./algorithms/cpp/binaryTreeRightSideView/binaryTreeRightSideView.cpp), [Python](./algorithms/python/BinaryTreeRightSideView/rightSideView.py)|Medium|
...
|162|[Find Peak Element](https://oj.leetcode.com/problems/find-peak-element/) | [C++](./algorithms/cpp/findPeakElement/findPeakElement.cpp), [Java](./algorithms/java/src/findPeakElement/findPeakElement.java), [Python](./algorithms/python/FindPeakElement/findPeakElement.py)|Medium|
...
|153|[Find Minimum in Rotated Sorted Array](https://oj.leetcode.com/problems/find-minimum-in-rotated-sorted-array/)| [C++](./algorithms/cpp/findMinimumInRotatedSortedArray/findMinimumInRotatedSortedArray.cpp), [Java](./algorithms/java/src/findMinimumInRotatedSortedArray/findMinimumInRotatedSortedArray.java), [Python](./algorithms/python/FindMinimumInRotatedSortedArray/findMin.py)|Medium|
...
|144|[Binary Tree Preorder Traversal](https://oj.leetcode.com/problems/binary-tree-preorder-traversal/)| [C++](./algorithms/cpp/binaryTreePreorderTraversal/binaryTreePreorderTraversal.cpp), [Java](./algorithms/java/src/binaryTreePreorderTraversal/binaryTreePreorderTraversal.java), [Python](./algorithms/python/BinaryTreePreorderTraversal/preorderTraversal.py)|Medium|
...
|112|[Path Sum](https://oj.leetcode.com/problems/path-sum/)| [C++](./algorithms/cpp/pathSum/pathSum.cpp), [Python](./algorithms/python/PathSum/hasPathSum.py)|Easy|
|111|[Minimum Depth of Binary Tree](https://oj.leetcode.com/problems/minimum-depth-of-binary-tree/)| [C++](./algorithms/cpp/minimumDepthOfBinaryTree/minimumDepthOfBinaryTree.cpp), [Python](./algorithms/python/MinimumDepthOfBinaryTree/minDepth.py)|Easy|
|110|[Balanced Binary Tree](https://oj.leetcode.com/problems/balanced-binary-tree/)| [C++](./algorithms/cpp/balancedBinaryTree/balancedBinaryTree.cpp), [Java](./algorithms/java/src/balancedBinaryTree/balancedBinaryTree.java), [Python](./algorithms/python/BalancedBinaryTree/isBalanced.py)|Easy|
...
|108|[Convert Sorted Array to Binary Search Tree](https://oj.leetcode.com/problems/convert-sorted-array-to-binary-search-tree/)| [C++](./algorithms/cpp/convertSortedArrayToBinarySearchTree/convertSortedArrayToBinarySearchTree.cpp), [Python](./algorithms/python/ConvertSortedArrayToBinarySearchTree/sortedArrayToBST.py)|Medium|
|107|[Binary Tree Level Order Traversal II](https://oj.leetcode.com/problems/binary-tree-level-order-traversal-ii/)| [C++](./algorithms/cpp/binaryTreeLevelOrderTraversal/binaryTreeLevelOrderTraversal.II.cpp), [Python](./algorithms/python/BinaryTreeLevelOrderTraversalII/levelOrderBottom.py)|Easy|
...
|104|[Maximum Depth of Binary Tree](https://oj.leetcode.com/problems/maximum-depth-of-binary-tree/)| [C++](./algorithms/cpp/maximumDepthOfBinaryTree/maximumDepthOfBinaryTree.cpp), [Java](./algorithms/java/src/maximumDepthOfBinaryTree/maximumDepthOfBinaryTree.java), [Python](./algorithms/python/MaximumDepthOfBinaryTree/maxDepth.py)|Easy|
...
|102|[Binary Tree Level Order Traversal](https://oj.leetcode.com/problems/binary-tree-level-order-traversal/)| [C++](./algorithms/cpp/binaryTreeLevelOrderTraversal/binaryTreeLevelOrderTraversal.cpp), [Java](./algorithms/java/src/binaryTreeLevelOrderTraversal/binaryTreeLevelOrderTraversal.java), [Python](./algorithms/python/BinaryTreeLevelOrderTraversal/levelOrder.py)|Easy|
|101|[Symmetric Tree](https://oj.leetcode.com/problems/symmetric-tree/)| [C++](./algorithms/cpp/symmetricTree/symmetricTree.cpp), [Python](./algorithms/python/SymmetricTree/isSymmetric.py)|Easy|
|100|[Same Tree](https://oj.leetcode.com/problems/same-tree/)| [C++](./algorithms/cpp/sameTree/sameTree.cpp), [Python](./algorithms/python/SameTree/isSameTree.py)|Easy|
...
|94|[Binary Tree Inorder Traversal](https://oj.leetcode.com/problems/binary-tree-inorder-traversal/)| [C++](./algorithms/cpp/binaryTreeInorderTraversal/binaryTreeInorderTraversal.cpp), [Python](./algorithms/python/BinaryTreeInorderTraversal/inorderTraversal.py)|Medium|
...
|90|[Subsets II](https://oj.leetcode.com/problems/subsets-ii/)| [C++](./algorithms/cpp/subsets/subsets.II.cpp), [Java](./algorithms/java/src/subsets/subsetsII.java), [Python](./algorithms/python/SubsetsII/subsetsWithDup.py)|Medium|
...
|75|[Sort Colors](https://oj.leetcode.com/problems/sort-colors/)| [C++](./algorithms/cpp/sortColors/sortColors.cpp), [Python](./algorithms/python/SortColors/sortColors.py)|Medium|
...
|64|[Minimum Path Sum](https://oj.leetcode.com/problems/minimum-path-sum/)| [C++](./algorithms/cpp/minimumPathSum/minimumPathSum.cpp), [Java](./algorithms/java/src/dynamicProgramming/minimumPathSum/minimumPathSum.java), [Python](./algorithms/python/MinimumPathSum/minimumPathSum.py)|Medium|
...
|62|[Unique Paths](https://oj.leetcode.com/problems/unique-paths/)| [C++](./algorithms/cpp/uniquePaths/uniquePaths.cpp), [Java](./algorithms/java/src/dynamicProgramming/uniquePaths/uniquePaths.java), [Python](./algorithms/python/UniquePaths/uniquePaths.py)|Medium|
...
|49|[Group Anagrams](https://oj.leetcode.com/problems/anagrams/)| [C++](./algorithms/cpp/anagrams/GroupAnagrams.cpp), [Python](./algorithms/python/GroupAnagrams/groupAnagrams.py)|Medium|
|48|[Rotate Image](https://oj.leetcode.com/problems/rotate-image/)| [C++](./algorithms/cpp/rotateImage/rotateImage.cpp), [Python](./algorithms/python/RotateImage/rotate.py)|Medium|
...
|40|[Combination Sum II](https://oj.leetcode.com/problems/combination-sum-ii/)| [C++](./algorithms/cpp/combinationSum/combinationSum.II.cpp), [Python](./algorithms/python/CombinationSumII/combinationSum2.py)|Medium|
|39|[Combination Sum](https://oj.leetcode.com/problems/combination-sum/)| [C++](./algorithms/cpp/combinationSum/combinationSum.cpp), [Python](./algorithms/python/CombinationSum/combinationSum.py)|Medium|
